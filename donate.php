  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
        ...
        if(isset($name) && isset($blood_group) && isset($gender) && isset($day) && isset($month) && isset($year) && isset($email) && isset($contact) && isset($city) && isset($password) && isset($blood_group)){
            ...
            $sql="INSERT INTO `donor` (`name`, `gender`, `email`, `city`, `dob`, `contact_no`, `safe_life_date`, `password`, `blood_group`) VALUES ('$name', '$gender', '$email', '$city', '$DonorDOB', '$contact', '0', '$password', '$blood_group')";
    ...
    echo $submitError;
            ...
            <form class="form-group" action="" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="fullname" placeholder="Full Name"  pattern="[A-Za-z/\s]+" title="Only lower and upper case and space" class="form-control" value="<?php if (isset($name)) {
    echo $name;
} ?>">
...
<?php if (isset($yearError)) {
    echo $yearError;
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="email" id="email" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" title="Please write correct email" class="form-control" value ="<?php if (isset($email)) {
                        echo $email;
                    } ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="contact_no"  placeholder="03********" class="form-control"  pattern="^\d{10}$" title="10 numeric characters only" maxlength="10" value="<?php if (isset($contact)) {
                        echo $contact;
                    } ?>">
...
<?php if (isset($cityError)) {
    echo $cityError;
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" value="" placeholder="Password" class="form-control"  pattern=".{6,}">

                </div><!--End form-group-->
                <div class="form-group">
                    <label for="password">Confirm Password</label>
                    <input type="password" name="c_password" value="" placeholder="Confirm Password" class="form-control"  pattern=".{6,}">
