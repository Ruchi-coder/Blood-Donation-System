...
if (isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])) {
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
        ...
        if (isset($name) && isset($blood_group) && isset($gender) && isset($day) && isset($month) && isset($year) && isset($email) && isset($contact) && isset($city) && isset($blood_group)) {
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
        ...
        if(isset($password)) {
            ...
            if (mysqli_query($connection, $sql)) {
                $updatePasswordError = '<div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    if (isset($_POST['delete_account'])) {
        if (isset($_POST['account_password']) && !empty($_POST['account_password'])) {
            ...
            if($account_password == $dbPassword){
                ...
                <button type="submit" name="updateDave" class="btn btn-danger">Yes</button>
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        ...
        <div class="row">
            ...
            <div class=" card col-md-6 offset-md-3">
                <div class="panel panel-default" style="padding: 20px;">
                    ...
                    <!-- Error Messages -->
    <?php if(isset($deletesubmitError)) {
        ...
        echo $showForm;
                    ...
                    <form class="form-group" action="" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="fullname" placeholder="Full Name"  pattern="[A-Za-z/\s]+" title="Only lower and upper case and space" class="form-control" value="<?php
                            if (isset($name)) {
                                echo $name;
                            }
                            ?>">
                        ...
                        <div class="form-group">
                            ...
                            Female<input type="radio" name="gender" id="gender" value="Female" style="margin-left:10px;" <?php
                                         if (isset($gender)) {
                                             if ($gender == "Female") {
                                                 echo "checked";
                                             }
    ...
    ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="contact_no"  placeholder="03********" class="form-control" pattern="^\d{10}$" title="10 numeric characters only" maxlength="10" value="<?php
                               if(isset($contact)) {
                                   echo $contact;
                               }
                                   ?>">
    ...
    <?php if (isset($updatePasswordError)) {
        echo $updatePasswordError;
            ...
            <div class="card col-md-6 offset-md-3">
                ...
                <!-- Display Message -->
    <?php if(isset($deleteAccountError)){
